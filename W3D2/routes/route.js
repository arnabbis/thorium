...
router.get('/MOVIEz', function (req, res){
    ...
    res.send([ {id: 1,name: 'The Shining'}, {id: 2,name: 'Incendies'},{id: 3,name: 'Rang de Basanti'},{id: 4,name:'Finding Demo'},{id: 5,name: 'border'}]);
});
// 4. this api will fetch all movies from array of objects by Indexid
router.get('/films/:flimId', function (req, res){
let movi=[{id: 1,name: 'The Shining'}, {id: 2,name: 'Incendies'},{id: 3,name: 'Rang de Basanti'},{id: 4,name:'Finding Demo'},{id: 5,name: 'border'}]
